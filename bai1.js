import { Text, View, StyleSheet,Pressable, InputAccessoryView} from 'react-native';
...
const styles = StyleSheet.create({
  ...
  <circle cx="71" cy="71" r="63.5" stroke="black" stroke-width="15"/>
        ...
        <Text style={{ textAlign: 'center', fontSize: 18, fontWeight: 700,marginTop: -20  }}>HOW WE WORK?</Text>
      </View>
...
/*Bai1 =()=>{
  ...
  return(
    <View style={styles.container}>
      ...
      <Text style={{textAlign: 'center', fontSize:25,fontWeight:700}}>FORGET{'\n'}PASSWORD
      </Text>

      <Text style={{textAlign: 'center', fontSize:15,fontWeight:700}}>Provide your account{'`'}s email for which you{'\n'} want to reset your password
      </Text>

      <InputAccessoryView style={styles.input}>
